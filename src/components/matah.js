...
<Container className='margin_top'>
  <Row className="justify-content-md-center">
    ...
    <Col sm={6}>
       ...
       <div className='d-grid img_information_bottom'><img src='../matah.webp' className='img_information'></img></div>
       ...
       <p> תמיד תוכלו להיכנס ל <Link to="/matah_calculator"> מחשבון מט"ח </Link>כאן באתר ולראות את שער ההמרה הנוכחי 
      </p>
      </div>
       </Col>
    <Col sm={3}></Col>
